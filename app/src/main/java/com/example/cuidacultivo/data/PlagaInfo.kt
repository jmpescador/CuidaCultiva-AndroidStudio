...
val plagasMap: Map<String, PlagaInfo> = mapOf(
    ...
    "Acaros_mora" to PlagaInfo(
        ...
        imagenRes = R.drawable.acaros_mora
    ),
    ...
    "Antracnosis_mora" to PlagaInfo(
        ...
        imagenRes = R.drawable.antracnosis_mora
    ),
    ...
    "Antracnosis" to PlagaInfo(
        ...
        imagenRes = R.drawable.antracnosis_cafe
    ),
    ...
    "Aranita_roja" to PlagaInfo(
        ...
        imagenRes = R.drawable.aranita_roja
    ),
    ...
    "Botrytis_mora" to PlagaInfo(
        ...
        imagenRes = R.drawable.botrytis_mora
    ),
    ...
    "Chinche_chamusquina" to PlagaInfo(
        ...
        imagenRes = R.drawable.chinche_chamusquina
    ),
    ...
    "Cochinilla_verde" to PlagaInfo(
        ...
        imagenRes = R.drawable.cochinilla_verde
    ),
    ...
    "Mildeo_polvose_mora" to PlagaInfo(
        ...
        imagenRes = R.drawable.mildeo_polcoso_mora
    ),
    ...
    "Nematodos_del_cafe" to PlagaInfo(
        ...
        imagenRes = R.drawable.nematodos_cafe
    ),
    ...
    "Phytophthora_mora" to PlagaInfo(
        ...
        imagenRes = R.drawable.phytophthora_mora
    ),
    ...
    "Roya" to PlagaInfo(
        ...
        imagenRes = R.drawable.roya_cafe
    ),
    ...
    "Trips_mora" to PlagaInfo(
        ...
        imagenRes = R.drawable.trips_mora
    )
)
